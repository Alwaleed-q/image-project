...
config = {
    ...
    "image": "https://lh3.googleusercontent.com/7zpxV2Bh33-1RH7d6-YdxJuTfLtvSjGI4BXZhA_K8Y_RUG6fhxfqrYvD8CAiGALgDLLUBA=s89", # You can also have a custom image by using a URL argument
